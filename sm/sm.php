...
function sm3($data, $raw = false) {
    return openssl_digest($data, "sm3", $raw);
}

function sm3_file($path, $raw = false) {
    return openssl_digest(file_get_contents($path), "sm3", $raw);
}
...
function sm4($data, $key, $mod) {
    //if (16 !== strlen($key)) return "Password must 16 Byte.";
    $sm4 = new SM4();
    if ($mod === "en") {
...
/*
* https://github.com/yinfany/sm/blob/master/SM4.php
*/
